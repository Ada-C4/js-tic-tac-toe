function TicTacToe() {
  ...
  this.player_1 = new Player(1, "Piggy", "🐷");
  this.player_2 = new Player(2, "Munksy", "🐵");
  this.current_player = this.player_2.isTurn ? this.player_2 : this.player_1;
...
TicTacToe.prototype.checkWinningBoard = function() {
  ...
  } else if ((this.board[1][0] === this.current_player.player) && (this.board[1][1] === this.current_player.number) && (this.board[1][2] === this.current_player.number)) {
